...
(define-pronunciation "inadvisable" "in[#]advisable" :text)
...
(define-pronunciation "congrats" "cong[#]rats" :text)
...
(define-pronunciation  "triangleright"   "triangle-right" :math)
...
(define-pronunciation  "<"   "less-than" :math)
